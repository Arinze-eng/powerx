  ...
  return (
    <div className="relative min-h-full w-full overflow-x-hidden bg-[#0b0a14] text-white">
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0b0a14]/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button type="button" onClick={onSignIn} className="rounded-control px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-white/10 sm:px-4">
              Sign in
            </button>
            <button type="button" onClick={onSignUp} className="group inline-flex items-center gap-1.5 rounded-control bg-gradient-to-r from-[#7C5CFF] to-[#22D3EE] px-3.5 py-2 text-sm font-semibold text-white shadow-lg shadow-[#7C5CFF]/25 transition-all hover:brightness-110 sm:px-5">
              Get started
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-20 pt-16 sm:px-8 sm:pt-24 lg:pb-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <button type="button" onClick={onSignUp} className="group inline-flex w-full items-center justify-center gap-2 rounded-control bg-gradient-to-r from-[#7C5CFF] to-[#22D3EE] px-6 py-3 text-sm font-semibold text-white shadow-xl shadow-[#7C5CFF]/30 transition-all hover:brightness-110 sm:w-auto">
                Start for free
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </button>
              <button type="button" onClick={onSignIn} className="inline-flex w-full items-center justify-center gap-2 rounded-control border border-white/20 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10 sm:w-auto">
              ...
              <div className="overflow-hidden rounded-panel border border-white/10 bg-[#0f0e1c]">
                ...
                <div className="space-y-4 p-5 sm:p-7">
                  <div className="flex justify-end">
                    <div className="max-w-[80%] rounded-panel rounded-tr-sm bg-gradient-to-br from-[#7C5CFF] to-[#5b6cff] px-4 py-2.5 text-sm text-white">
                      Summarize this quarter's sales CSV and make a chart + one-page report.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CdnaiMark className="mt-0.5 h-7 w-7" />
                    <div className="max-w-[85%] space-y-2 rounded-panel rounded-tl-sm border border-white/10 bg-white/[0.04] px-4 py-3 text-sm">
      ...
      <section className="border-y border-white/10 bg-white/[0.02]">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-10 gap-y-3 px-5 py-6 text-sm text-white/55 sm:px-8">
      ...
      {/* Features */}
      <section id="features" className="relative mx-auto max-w-6xl scroll-mt-20 px-5 py-20 sm:px-8 lg:py-28">
        ...
        <div id="capabilities" className="mt-14 grid scroll-mt-20 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {FEATURES.map((f) => (
            <div key={f.title} className="group rounded-panel border border-white/10 bg-white/[0.03] p-6 transition-all hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.06]">
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {STEPS.map((s, i) => (
              <div key={s.title} className="relative">
                <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-[#7C5CFF] to-[#22D3EE] text-sm font-bold text-white">{i + 1}</div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 sm:px-8 lg:py-28">
        <div className="relative overflow-hidden rounded-prominent border border-white/10 bg-gradient-to-br from-[#1a1636] via-[#241a4d] to-[#0d2330] px-6 py-16 text-center shadow-2xl sm:px-12">
          ...
          <div className="relative">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">Give your work an AI partner</h2>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <button type="button" onClick={onSignUp} className="group inline-flex w-full items-center justify-center gap-2 rounded-control bg-white px-6 py-3 text-sm font-semibold text-[#12101f] transition-transform hover:scale-[1.02] sm:w-auto">
                Create free account
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </button>
              <button type="button" onClick={onSignIn} className="inline-flex w-full items-center justify-center rounded-control border border-white/25 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10 sm:w-auto">
                Sign in
              </button>
            </div>
          </div>
