...
def test_bootstrap_keeps_transport_and_business_limits_separate() -> None:
    ...
    # A policy-valid message must fit inside the 141 MB WebSocket frame ceiling.
    minimum = policy.minimum_full_policy_frame_bytes()
    assert minimum < 141_000_000
    assert minimum > 130 * 1024 * 1024  # sized for 100 MB files, not small images
