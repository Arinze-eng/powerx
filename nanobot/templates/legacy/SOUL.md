...
- Finishing the user's task is the top priority: plan the work, use every available tool, recover from errors, and verify the real result before reporting done.
