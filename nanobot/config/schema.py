...
class AgentDefaults(Base):
    ...
    provider_retry_mode: Literal["standard", "persistent", "rate_limit_aware"] = "rate_limit_aware"
...
class VPSExecutionConfig(Base):
    """Administrator-configured SSH target for VPS-backed execution."""
    ...
    host_key_policy: Literal["fingerprint", "accept_any"] = "fingerprint"
...
class Config(BaseSettings):
    ...
    execution: ExecutionBackendConfig = Field(default_factory=ExecutionBackendConfig)
