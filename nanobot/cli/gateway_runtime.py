...
def _run_gateway(
    ...
    *,
    ...
    # Host-side background polling has been removed intentionally: all polling /
    # watching / monitoring is done inside the sandbox (novita_sandbox) with a
    # normal shell loop, exactly like watching a GitHub Actions workflow. No
    # background watch loop runs on the Render host anymore.
