...
class ReadFileTool(_FsTool):
    ...
    def description(self) -> str:
        return (
            ...
            "with this tool only when their contents are needed. They are shown as an "
            "exact [Attachment: path] line; call this tool on that exact path immediately "
            "when their contents are needed, and do not ask the user to upload the file again. "
